<%-- 
    Document   : cabecera
    Created on : 03-mar-2021, 18:07:34
        ...
        <div class="container mt-4">
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="formCliente.htm">Transportista</a></li>
                    <li><a href="formConsultarCliente.htm">Visualizar Transportista</a></li>
                    <li><a class="active" href="listarClientes.htm">About</a></li>
                </ul>
            </nav> 
